...
/**
 * @brief Encodes a binary file into a PNG image using steganography.
 *
 * This function hides the contents of a specified binary file within the least significant bits
 * of the blue channel of each pixel in the carrier PNG image. The file data is protected with an
 * 8-character password using the Vigenère Cipher.
 *
 * @param inputImagePath Path to the input (carrier) PNG image.
 * @param outputImagePath Path where the output PNG image with the hidden file will be saved.
 * @param inputFilePath Path to the binary file to hide within the PNG image.
 * @param password An 8-character password used to scramble the file data for protection.
